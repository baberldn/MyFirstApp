...
export default function LessonsScreen({ navigation }) {
  return (
    <ScrollView style={styles.container}>
      ...
      >
        <View style={[styles.lessonBadge, { backgroundColor: '#e67e22' }]}>
          <Text style={styles.lessonText}>DERS 5</Text>
        </View>
        <Text style={styles.header}>React Navigation</Text>
        <Text style={styles.subtitle}>Stack Navigator, Params, Ekranlar arası geçiş</Text>

        <View style={styles.navDemoPreview}>
          <Text style={styles.navDemoText}>Mağaza Uygulamasını Aç →</Text>
        </View>
      </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  // Ders 5 Navigation Demo stilleri
  navDemoPreview: {
